      ...
      <h3>
        ...
        <button type="button" onClick={toggleSearch} data-isactive={searchwrap} className="searchbtn">
          <svg id="Layer_1" version="1.1" viewBox="0 0 50 50">
            ...
            <circle cx="21" cy="20" fill="none" r="16" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" />
            <line fill="none" strokeMiterlimit="10" strokeWidth="4" x1="32.229" x2="45.5" y1="32.229" y2="45.5" />
          </svg>
        </button>
